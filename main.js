...
const data = require('./public/data/mri.json')
...
async function loadModel(file) {
	model = await tf.loadModel(path.join(__dirname, 'public/model/model.json')).then(function(){
		console.log('Model Has Been Loaded');
		test(data)}).catch((err)=>console.log(err));
